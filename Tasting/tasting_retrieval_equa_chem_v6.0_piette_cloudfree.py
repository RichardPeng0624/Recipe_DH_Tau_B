"""
tasting_retrieval_equa_chem_v6.0_piette_cloudfree.py
=====================================================
Series 006PM-EQ — Equilibrium chemistry, cloud-free, with atomic species Na, Ca, Ti and HF

Based on 005PM-EQ (tasting_retrieval_equa_chem_v5.0_piette_RM.py).
Uses Guidebook_GAStronomy_Piette_v4.0.

Changes from v5.0
-----------------
- Imports Guidebook v4.0 (adds HF, Na, Ca, Ti to opacity species list)
- make_free_params_equilibrium() now includes log_HF, log_Na, log_Ca, log_Ti
  with prior U(-12, -2) following Picos et al. (2024) §4.2, Table 3.
- Hybrid chemistry: equilibrium table for main molecular species (H2O, CO, CH4,
  NH3, H2S, HCN, CO2, FeH); free params for HF, Na, Ca, Ti (absent from eq table).
- HF uses [F/H] parameterisation (Picos+2024 Eq. 3):
    [F/H] = log10(n_HF/n_H) - log10(n_HF/n_H)_solar,  solar = -7.6 (Maiorca+2014).
  VMR_HF is derived internally: log VMR_HF = [F/H] - 7.6 + log10(2 × VMR_H2).
- Na, Ca, Ti retrieved as direct log VMR (log_Na, log_Ca, log_Ti).
...
# ===========================================================================
# FREE PARAMETERS — 006PM-EQ (equil. chem, cloud-free, HF/Na/Ca/Ti as free VMR)
# ===========================================================================
...
free_params = make_free_params_equilibrium()   # includes log_HF, log_Na, log_Ca, log_Ti
...
plt.title('P-T profile (Piette+2020 PCHIP) — 006PM-EQ cloud-free')
