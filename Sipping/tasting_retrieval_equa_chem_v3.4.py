...
class pRT_spectrum:
    ...
    def make_pt(self):
        ...
        # v3.4: nabla_4 (2nd radiative node) removed; 78% of 4131995 posterior was
        # pinned at the lower boundary (0.00), confirming it is unconstrained at
        # pressures below ~0.015 bar where CRIRES+ has no sensitivity.
...
free_params = {
    ...
    'nabla_2':    ([0.04, 0.34],  r'$\nabla_{T,2}$'),
    'nabla_3':    ([0.00, 0.34],  r'$\nabla_{T,3}$'),
    # nabla_4 removed in v3.4: 78% of 4131995 posterior pinned at lower bound (0.00);
    # node sits at ~0.015 bar, above CRIRES+ sensitivity. nabla_5 covers top directly.
    'nabla_5':    ([0.00, 0.34],  r'$\nabla_{T,5}$'),
    'T_bottom':   ([2000, 5000],  r'$T_{\rm bot}$'),
