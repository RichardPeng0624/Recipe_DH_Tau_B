"""
tasting_retrieval_free_chem_v6.0_piette_cloudfree.py
=====================================================
Series 006PM-FR — Free chemistry, cloud-free, with atomic species Na, Ca, Ti and HF

Based on 005PM-FR (tasting_retrieval_free_chem_v5.0_piette_RM.py).
Uses Guidebook_GAStronomy_Piette_v4.0.

Changes from v5.0
-----------------
- Imports Guidebook v4.0 (adds HF, Na, Ca, Ti to opacity species list)
- make_free_params_free_chem() now includes log_HF, log_Na, log_Ca, log_Ti
  with prior U(-12, -2) following Picos et al. (2024) §4.2, Table 3.

Species retrieved
-----------------
Molecular : H2O, 12CO, 13CO, CH4
Atomic/HF : HF, Na, Ca, Ti  [new in v4.0]
...
# ===========================================================================
# FREE PARAMETERS — 006PM-FR (free chem, cloud-free, HF + Na + Ca + Ti)
# ===========================================================================

constant_params = {}   # no chemistry key → defaults to free VMR mode

free_params = make_free_params_free_chem()   # includes log_HF, log_Na, log_Ca, log_Ti
...
plt.title('P-T profile (Piette+2020 PCHIP) — 006PM-FR cloud-free')
