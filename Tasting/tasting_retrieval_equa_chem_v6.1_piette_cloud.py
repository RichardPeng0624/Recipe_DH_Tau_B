"""
tasting_retrieval_equa_chem_v6.1_piette_cloud.py
=================================================
Series 007PM-EQ-CLD — Equilibrium chemistry + EddySed clouds + GP correlated noise

Based on 006PM-EQ-CLD (tasting_retrieval_equa_chem_v6.0_piette_cloud.py).
Uses Guidebook_GAStronomy_Piette_v4.2.

Changes from v6.0
-----------------
- Imports Guidebook v4.2 (banded GP Cholesky + Standard Gaussian likelihood fix +
  geometric-mean GP kernel — resolves OOM and log_a saturation from v4.1).
- cov_mode = 'GP' — correlated noise modelled with heteroscedastic GP kernel
  following González Picos et al. (2025) §4.2, geometric-mean variant (v4.2):
    Sigma_0,ij = delta_ij*sigma_i^2  +  a^2*sigma_i*sigma_j*exp(-Delta_lambda^2/2l^2)
...
# ===========================================================================
# FREE PARAMETERS — 007PM-EQ-CLD (equil. chem + EddySed clouds + GP noise)
# ===========================================================================
...
plt.title('P-T profile (Piette+2020 PCHIP) — 007PM-EQ-CLD EddySed GP')
