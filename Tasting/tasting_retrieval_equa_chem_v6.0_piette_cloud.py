"""
tasting_retrieval_equa_chem_v6.0_piette_cloud.py
=================================================
Series 006PM-EQ-CLD — Equilibrium chemistry + EddySed clouds (MgSiO3 + Fe)
                       with atomic species Na, Ca, Ti and HF

Based on 005PM-EQ-CLD (tasting_retrieval_equa_chem_v5.0_piette_cloud.py).
Uses Guidebook_GAStronomy_Piette_v4.0.

Changes from v5.0
-----------------
- Imports Guidebook v4.0 (adds HF, Na, Ca, Ti to opacity species list)
- make_free_params_equil_chem_cloudy() now includes log_HF, log_Na, log_Ca, log_Ti
...
plt.title('P-T profile (Piette+2020 PCHIP) — 006PM-EQ-CLD EddySed clouds')
