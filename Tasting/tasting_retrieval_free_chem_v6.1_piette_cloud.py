"""
tasting_retrieval_free_chem_v6.1_piette_cloud.py
=================================================
Series 007PM-FR-CLD — Free chemistry + EddySed clouds + GP correlated noise

Based on 006PM-FR-CLD (tasting_retrieval_free_chem_v6.0_piette_cloud.py).
Uses Guidebook_GAStronomy_Piette_v4.1.
...
_guidebook_path = os.path.join(
    ...
    '..', 'Tasting_guidebook', 'Guidebook_GAStronomy_Piette_v4.1.py',
)
_spec = importlib.util.spec_from_file_location('Guidebook_GAStronomy_Piette_v4_1', _guidebook_path)
...
# ===========================================================================
# FREE PARAMETERS — 007PM-FR-CLD (free chem + EddySed clouds + GP noise)
# ===========================================================================
...
plt.title('P-T profile (Piette+2020 PCHIP) — 007PM-FR-CLD EddySed GP')
