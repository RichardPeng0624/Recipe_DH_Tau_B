"""
tasting_retrieval_free_chem_v4.0_piette.py
===========================================
Series 003PM-FR — Free chemistry + Piette & Madhusudhan (2020) P-T profile

[002PM-FR used same Guidebook as 885739 (EQ); 003PM-FR updates the Guidebook with:]
...
# ===========================================================================
# FREE PARAMETERS — Piette+2020 P-T + free chemistry (003PM-FR)
# ===========================================================================

constant_params = {}   # chemistry flag absent → pRT_spectrum defaults to 'free'

# Default parameter set from Guidebook (T_anchor + dT_1-7 + log VMRs for
# H2O, 12CO, 13CO, CH4).  Modify priors here if needed.
