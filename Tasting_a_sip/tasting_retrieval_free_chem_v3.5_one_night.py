...
# v3.5.1: single-night retrieval — Night 2 loading removed.
...
free_params = {#'rv': ([27, 37], r'$v_{\rm rad}$'), # km/s - uniform prior
                'rv': ({'type': 'gaussian', 'mu': 16, 'sigma': 0.5}, r'$v_{\rm rad}$'), # km/s - Gaussian prior based on literature value, barycentric RV
...
# v3.5.1: single-night — no night-2 output to save.
