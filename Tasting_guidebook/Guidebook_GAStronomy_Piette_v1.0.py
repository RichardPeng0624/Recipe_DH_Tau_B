...
def make_free_params_equilibrium():
    """Default free parameter dictionary for equilibrium chemistry (003PM-EQ).
    ...
    Xuan+2024 §4.3.4 method: pressure nodes customised so ≥ 4 nodes fall
    in the region where 90% of K-band flux originates (ECF peak ≈ 0.1 bar
    for DH Tau B); remaining nodes equally spaced in log P.  Priors bracket
    self-consistent model ΔT values with wide ±50–100% margins.

    DH Tau B properties: T_eff ~ 2050 K, log g ~ 3.5, m ~ 12 M_Jup.
