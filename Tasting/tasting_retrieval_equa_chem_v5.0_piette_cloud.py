"""
tasting_retrieval_equa_chem_v5.0_piette_cloud.py
=================================================
Series 005PM-EQ-CLD — Equilibrium chemistry + EddySed clouds (MgSiO3 + Fe)

Based on 005PM-EQ (tasting_retrieval_equa_chem_v5.0_piette_RM.py) but adds the
Ackerman & Marley (2001) EddySed cloud model following Xuan et al. (2024) §4.3.3.
Uses Guidebook_GAStronomy_Piette_v3.0.
...
# ---------------------------------------------------------------------------
# Import Guidebook v3.0
# ---------------------------------------------------------------------------
import importlib.util

_guidebook_path = os.path.join(
    os.path.dirname(os.path.abspath(__file__)),
    '..', 'Guidebook_GAStronomy_Piette_v3.0.py',
)
_spec = importlib.util.spec_from_file_location('Guidebook_GAStronomy_Piette_v3_0', _guidebook_path)
...
# ===========================================================================
# FREE PARAMETERS — 005PM-EQ-CLD (absolute flux + equil. chem + EddySed clouds)
# ===========================================================================
...
plt.title('P-T profile (Piette+2020 PCHIP) — 005PM-EQ-CLD EddySed clouds')
