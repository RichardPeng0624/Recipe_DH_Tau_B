"""
tasting_retrieval_equa_chem_v4.p_picos_DG.py
=============================================
Series 001DG-EQ — Equilibrium chemistry + Dynamic Gradients (DG) P-T profile
...
# ===========================================================================
# FREE PARAMETERS — DG P-T (Picos+2025) + equilibrium chemistry (001DG-EQ)
# ===========================================================================

constant_params = {'chemistry': 'equilibrium'}

# Default equilibrium parameter set from Guidebook (nabla_* + T_bottom +
...
# To add/remove species edit EQ_SPECIES_PRT3 / get_species() in the Guidebook.
