"""
tasting_retrieval_free_chem_v5.0_piette_cloud.py
=================================================
Series 005PM-FR-CLD — Free chemistry + EddySed clouds (MgSiO3 + Fe)

Based on 005PM-FR (tasting_retrieval_free_chem_v5.0_piette_RM.py) but adds the
...
# ===========================================================================
# FREE PARAMETERS — 005PM-FR-CLD (absolute flux + free chem + EddySed clouds)
# ===========================================================================
...
plt.title('P-T profile (Piette+2020 PCHIP) — 005PM-FR-CLD EddySed clouds')
