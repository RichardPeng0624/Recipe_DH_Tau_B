"""
tasting_retrieval_equa_chem_v6.1_piette_cloudfree_mednorm.py
=============================================================
Series 008PM-EQ-MEDNORM — Equilibrium chemistry, cloud-free, per-chip median
normalisation (data AND model), Standard Gaussian likelihood, GP correlated
noise.
...
plt.title('P-T profile (Piette+2020 PCHIP) — 008PM-EQ-MEDNORM')
